...
The product repository is both a catalog of portable skills and the source of the factory rules that govern them.
...
- A real skill lives directly under the repository root. Nested category folders are not used because not every host discovers nested skills consistently.
